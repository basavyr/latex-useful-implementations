...
\begin{figure}
    ...
    \begin{tikzpicture}[every text node part/.style={align=center}]
        ...
        \node[rectangle] (pes-image-box) [right=of first-box,xshift=-1cm] {\includegraphics[scale=0.3]{Chapters/Figures/repulsive_interaction.pdf}};
        ...
        \node[rectangle] (pes-image-box) [right=of second-box,xshift=-1cm] {\includegraphics[scale=0.12]{Chapters/Figures/PES_small_update.png}};
        ...
        \node[rectangle] (precession-cone-box) [right=of third-box,xshift=-1cm] {\includegraphics[scale=0.25]{Chapters/Figures/precessional_cone.png}};
