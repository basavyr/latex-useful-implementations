...
\begin{figure}
    ...
    \begin{tikzpicture}[every text node part/.style={align=center}]
        ...
        \begin{axis}[scale=0.6,xshift=-2cm,every axis plot post/.append style={
            ...
            \addplot [name path=particle-density, color=blue,very thick] {\gauss{0}{0.4}};
            \addplot [name path=core-density, color=black!60!green,very thick] {\gauss{1.7}{0.65}};
            ...
            \node[rectangle, draw=none, thick, fill=none] at (axis cs: 1,1.2) (inside-node) {Density distributions for $\mathcal{Q}_n$ and $\mathscr{C}$};
