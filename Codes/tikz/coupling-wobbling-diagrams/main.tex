...
\begin{figure}
        ...
        \begin{tikzpicture}[every text node part/.style={align=center}]
            ...
            \begin{axis}[scale=0.6,xshift=-2cm,every axis plot post/.append style={
                ...
                \addplot [name path=core-density, color=black!60!green,ultra thick] {\gauss{0.5}{0.65}};
...
\begin{figure}
    ...
    \begin{tikzpicture}[every text node part/.style={align=center}]
        ...
        \begin{axis}[scale=0.6,xshift=-2cm,every axis plot post/.append style={
            ...
            \addplot [name path=obs,ultra thick, smooth, color=black!60!green] {\gauss{6}{1.5}};
